...
Template_14_15 <- read_excel(here("Template Datasets", "Template_14_15.xlsx"))
...
while (y < 380){
  ...
  #the URL link to each Match Report (containing the match statistics) on FBref is in column 16 of the template dataset
    ...
    HomeGK <- colSums(as.data.frame(sapply(data.5.2, as.numeric)))
    ...
    AwayGK <- colSums(as.data.frame(sapply(data.7.2, as.numeric)))
...
```{r}
#Load in template dataset from GitHub repository
Template_15_16 <- read_excel(here("Template Datasets", "Template_15_16.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_16_17 <- read_excel(here("Template Datasets", "Template_16_17.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_17_18 <- read_excel(here("Template Datasets", "Template_17_18.xlsx"))
...
while (y < 380) {
  for (i in x:y){
    ...
    HomeGK <- colSums(as.data.frame(sapply(data.10.2, as.numeric)))
    ...
    #Column summing the individual away team goalkeeper stats to get total goalkeeper stats, and saving them as a numeric data frame called "AwayGK"
    AwayGK <- colSums(as.data.frame(sapply(data.17.2, as.numeric)))
...
```{r}
#Load in template dataset from GitHub repository
Template_18_19 <- read_excel(here("Template Datasets", "Template_18_19.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_19_20 <- read_excel(here("Template Datasets", "Template_19_20.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_20_21 <- read_excel(here("Template Datasets", "Template_20_21.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_21_22 <- read_excel(here("Template Datasets", "Template_21_22.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_22_23 <- read_excel(here("Template Datasets", "Template_22_23.xlsx"))
...
```{r}
#Load in template dataset from GitHub repository
Template_23_24 <- read_excel(here("Template Datasets", "Template_23_24.xlsx"))
...
write_xlsx(EPL_Totals, here("Template Datasets", "EPL_Totals.xlsx"))
```
